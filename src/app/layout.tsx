...
export const metadata: Metadata = {
  title: "RVM Studio - Creative agency & portfolio",
  description: "RVM Studio - Professional creative agency specializing in branding, web design, and digital solutions",
};
